...
```{r tabla comparativa c, echo=FALSE}
library(knitr)
library(kableExtra)
...
**Conclusión final del punto c:** En síntesis, ambos planes ofrecen una
protección equivalente al consumidor en términos de curva OC y AOQL. La
diferencia determinante es el esfuerzo de inspección: el plan doble
...
un 20% menor que el del plan simple, traduciendo ese ahorro directamente
en reducción de costos operativos sin sacrificar la protección exigida.
