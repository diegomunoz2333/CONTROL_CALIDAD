...
Se replicará la metodología del plan de muestreo simple para este esquema de muestreo doble. Los valores han sido calculados mediante las funciones correspondientes, con excepción del plan doble reducido, cuyos parámetros se han predefinido para los fines académicos de este ejercicio:
...
En síntesis, los planes normales, y en particular el nivel II, representan el punto
...
Respecto al número promedio total inspeccionado (ATI), el plan de muestreo doble puede resultar más eficiente en ciertos casos, ya que permite tomar decisiones tempranas después de la primera muestra cuando la calidad del lote es claramente buena o claramente mala. Esto puede reducir el esfuerzo total de inspección en comparación con el plan simple.

En conclusión, ambos planes presentan comportamientos estadísticos similares en términos de OC y AOQ, lo que indica niveles de protección comparables frente a la calidad del lote. No obstante, el plan doble puede ofrecer una ventaja en términos de eficiencia de inspección debido a la posibilidad de tomar decisiones con una primera muestra. Por otro lado, el plan simple presenta una aplicación operativa más directa al requerir siempre el mismo tamaño de muestra. Por lo tanto, la elección entre ambos dependerá del equilibrio deseado entre simplicidad operativa y eficiencia en el esfuerzo de inspección.
